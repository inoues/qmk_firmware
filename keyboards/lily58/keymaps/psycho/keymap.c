...
[_RAISE] = LAYOUT( \
  ...
  _______, XXXXXXX, XXXXXXX, KC_WINU, XXXXXXX, XXXXXXX,                    XXXXXXX, KC_PSCR, KC_ALPS, XXXXXXX, KC_CAD,   KC_F12, \
  _______, XXXXXXX, KC_WINL, KC_WIND, KC_WINR, XXXXXXX,                    XXXXXXX,  KC_INS, KC_HOME, XXXXXXX,  KC_UP,  XXXXXXX, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CPUP, KC_CPDN,  KC_ALUP,  KC_DEL,  KC_END, KC_LEFT, KC_DOWN, KC_RGHT, \
                             _______, _______, _______, _______, _______,  _______, _______, _______\
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
