...
[_LOWER] = LAYOUT( \
  KC_ESC , _______, _______, _______, _______, _______,                      KC_PPLS, KC_7,      KC_8,     KC_9, KC_CIRC,    KC_JYEN, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_PMNS, KC_4,      KC_5,     KC_6, KC_TILD,    KC_PIPE, \
